    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="relative z-10 space-y-8">
          <div>
            ...
            <p className="text-purple-200 text-base leading-relaxed max-w-xs">
              Chỉ một vài thông tin nữa là bạn có thể tham gia các câu lạc bộ và trải nghiệm đầy đủ hệ thống.
            </p>
          </div>
          ...
          <div className="space-y-3">
            {CHECKLIST.map(item => (
              <div key={item} className="flex items-center gap-3">
                <CheckCircle2 size={18} className="text-purple-300 flex-shrink-0" />
        ...
        <div className="relative z-10">
          <p className="text-purple-300 text-xs">© 2026 UniClub Hub · Hệ thống quản lý câu lạc bộ sinh viên</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <div className="mb-6">
            <h1 style={{ fontSize: '2rem', fontWeight: 800, letterSpacing: '-0.5px', margin: '0 0 6px 0', color: '#0f172a', lineHeight: 1.2 }}>
              Hoàn tất hồ sơ
            </h1>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-2">
            ...
            <div className="flex items-center gap-3 py-1">
              ...
              <span style={{ fontSize: '0.7rem', color: '#9ca3af', whiteSpace: 'nowrap', fontWeight: 500, letterSpacing: '0.05em', textTransform: 'uppercase' }}>
                Tuỳ chọn
              </span>
              <div style={{ flex: 1, height: '1px', background: '#e5e7eb' }} />
            </div>
