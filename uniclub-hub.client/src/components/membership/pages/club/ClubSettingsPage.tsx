...
export default function ClubSettingsPage() {
  ...
  if (loading) return (
    <div style={{ padding: '28px 32px', minHeight: '100%', background: D.bg, fontFamily: "'Be Vietnam Pro', sans-serif", fontSize: 13, color: D.inkMuted }}>
      Đang tải...
    </div>
  )
  ...
  return (
    <div style={{ padding: '28px 32px', minHeight: '100%', background: D.bg, fontFamily: "'Be Vietnam Pro', sans-serif" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 13, color: D.inkMuted, marginTop: 4 }}>Cập nhật thông tin và hình ảnh câu lạc bộ</p>
      </div>
