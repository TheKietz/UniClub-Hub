...
export default function ClubManageLayout() {
  ...
  const navItems = [
    ...
    {
      to: `/clubs/${id}/manage/applications`,
      label: "Đơn đăng ký",
      icon: FileText,
    },
    {
      to: `/clubs/${id}/manage/departments`,
      label: "Ban bộ phận",
      icon: Building,
    },
    {
      to: `/clubs/${id}/manage/form`,
      label: "Form đăng ký",
      icon: ClipboardList,
    },
    {
      to: `/clubs/${id}/manage/orgchart`,
      label: "Sơ đồ tổ chức",
      icon: Network,
    },
    {
      to: `/clubs/${id}/manage/audit-log`,
      label: "Lịch sử thay đổi",
      icon: History,
    },
    {
      to: `/clubs/${id}/manage/resignations`,
      label: "Đơn từ chức",
      icon: LogOut,
    },
    {
