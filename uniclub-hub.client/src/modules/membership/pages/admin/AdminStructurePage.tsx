...
import { getAdminClubs } from '@/modules/membership/services/adminApi'
import { getDepartments } from '@/modules/membership/services/clubApi'
import type { ClubItem } from '@/modules/membership/services/admin.types'
import type { DepartmentItem } from '@/modules/membership/services/club.types'
...
import { Plus, Pencil, Trash2, Building2, Search, GitBranch } from 'lucide-react'
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center gap-2">
                  <Link to={`/clubs/${club.id}/manage/orgchart`}
                    ...
                    style={{ borderColor: clr.border, color: clr.icon }}>
