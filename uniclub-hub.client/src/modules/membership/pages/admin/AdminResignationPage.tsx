...
import { getAdminResignations, reviewAdminResignation } from '@/modules/membership/services/clubApi'
import type { ResignationRequestItem, ReviewResignationDto } from '@/modules/membership/services/club.types'
...
export default function AdminResignationPage() {
  ...
  return (
    <div className="px-8 pt-6 pb-8 space-y-5">
      <div>
        <h1 className="text-xl font-bold text-gray-900">Đơn từ chức Trưởng CLB</h1>
            ...
            {loading ? (
              ...
              <TableRow>
                <TableCell colSpan={6} className="py-16">
                  <div className="flex flex-col items-center gap-2 text-gray-400">
                    ...
                    <p className="text-sm">Chưa có đơn từ chức nào.</p>
                  </div>
                </TableCell>
              </TableRow>
            ) : filtered.map(r => {
              ...
              return (
                <TableRow key={r.id} className="hover:bg-gray-50/60 transition-colors">
                  ...
                  <TableCell className="text-sm text-gray-700 font-medium">{r.clubName}</TableCell>
          ...
          {selected && (
            <div className="space-y-4 py-1">
              <div className="bg-gray-50 rounded-lg px-4 py-3 text-sm space-y-1">
                <p className="text-gray-500">CLB: <span className="text-gray-800 font-medium">{selected.clubName}</span></p>
              ...
              {selected.status === 'Pending' && (
                <div className="space-y-2">
                  <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Ghi chú <span className="text-gray-400 normal-case font-normal">(tuỳ chọn)</span></p>
