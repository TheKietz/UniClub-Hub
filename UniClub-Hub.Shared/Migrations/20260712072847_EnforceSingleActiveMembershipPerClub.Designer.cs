...
namespace UniClub_Hub.Shared.Migrations
{
    ...
    [Migration("20260712072847_EnforceSingleActiveMembershipPerClub")]
    partial class EnforceSingleActiveMembershipPerClub
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UniClub_Hub.Shared.Models.ClubApplication", b =>
                {
                    ...
                    b.Property<string>("MemberFieldData")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("UniClub_Hub.Shared.Models.EventAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UniClub_Hub.Shared.Models.KanbanColumn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UniClub_Hub.Shared.Models.NotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("ClubId", "TriggerKey", "RecipientRole")
                        .IsUnique();

                    b.ToTable("NotificationPreferences");
                });

            modelBuilder.Entity("UniClub_Hub.Shared.Models.PageView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("UniClub_Hub.Shared.Models.ClubApplication", b =>
                {
                    ...
                    b.HasOne("UniClub_Hub.Shared.Models.ClubPipelineStage", "CurrentStage")
                        .WithMany("Applications")
            ...
            modelBuilder.Entity("UniClub_Hub.Shared.Models.ClubEvent", b =>
                {
                    ...
                    b.HasOne("UniClub_Hub.Shared.Models.Club", null)
                        .WithMany("Events")
            ...
            modelBuilder.Entity("UniClub_Hub.Shared.Models.ClubTask", b =>
                {
                    ...
                    b.HasOne("UniClub_Hub.Shared.Models.KanbanColumn", "KanbanColumn")
                        .WithMany()
            ...
            modelBuilder.Entity("UniClub_Hub.Shared.Models.EventAttachment", b =>
                {
                    ...
                    b.HasOne("UniClub_Hub.Shared.Models.ApplicationUser", "UploadedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("UniClub_Hub.Shared.Models.MediaGallery", b =>
                {
                    ...
                    b.HasOne("UniClub_Hub.Shared.Models.ApplicationUser", "UploadedBy")
                        .WithMany()
